(function (exports){    
  ...
  var sessionId = "1_MX4yODE3MzA3Mn4xMjcuMC4wLjF-U2F0IE1heSAwNCAwNjo1NDoyMyBQRFQgMjAxM34wLjcyNTE3MTE1fg";
  ...
  exports.streaming.serverConnectedHandler = function(event) {
    var publisher = TB.initPublisher(apiKey, publishDiv);
    //var sub = TB.initSubscriber(apiKey, 'mySubDiv');
    session.publish(publisher);
    //session.subscribe(sub);
    $('#'+publishDiv).css('width','300px');
  }
